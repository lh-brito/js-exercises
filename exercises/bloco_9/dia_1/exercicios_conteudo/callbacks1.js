...
// Complete a função getUser de forma que ela receba uma outra função como 
// parâmetro para que possa realizar as operações abaixo sobre a pessoa retornada.
...
const getUser = (callback) => callback(userToReturn);

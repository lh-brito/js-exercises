...
// array deverá ser 45, pois é a multiplicação de 5 (primeiro valor) e 9 (valor seguinte).
// Já o segundo valor do novo array deverá ser 27, pois é a 
...
for (let index = 0; index < numbers.length; index += 1) {
    if (index !== numbers.length - 1) {
        multiplier.push(numbers[index] * numbers[index + 1]);
    }
    else {
        multiplier.push(numbers[index] * 2)
    }
}

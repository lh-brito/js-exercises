...
// * Caso contrário, ela deve ser rejeitada. Acresça um then , com um console.log('Promise resolvida') e um catch, 
// * com um console.log('Promise rejeitada') à Promise , só para que o código funcione e possamos ver o resultado.
// * Tente usar Higher Order Functions! Lembre-se de que tanto uma quanto a outra recebem, como parâmetro, funções!

const fetchPromise = () =>
  new Promise((resolve, reject) => 
    Array.from({ length: 10 }, () => Math.floor(Math.random() * 50) + 1 )
      .map((num) => num * num).reduce((sum, num) => sum + num) 
        < 8000 ? resolve() : reject() )
